...
namespace lab2
{
    ...
    class Class1
    {
        ...
        {//массив объектов
            ...
            student[0] = new Student("Andreev", "Andrey", "Andreevich", 2006, "Belorusskaya Street", 375297778888, "FIT", 3, 4);
            student[1] = new Student("Ivanov", "Ivan", 2005, "XTIT", 3, 5);
            student[2] = new Student();
            student[3] = new Student("Aleksandrov", "Aleksandr", "Sergeevich", 2005, "Belorusskaya Street", 375446668888, "FIT", 3, 4);
            student[4] = new Student("Nikolaev", "Nikolay", "Nikolaevich", 2006, "Kypalavskaya street", 375297778888, "IEF", 1, 1);
